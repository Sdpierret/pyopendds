...
class CppOutput(Output):
    ...
    def visit_struct(self, struct_type):
        ...
        for field_name, field_node in struct_type.fields.items():
            ...
            pyopendds_type = ""
            is_string = (
                isinstance(field_node.type_node, PrimitiveType)
                and field_node.type_node.is_string()
            )
